...
#to print everything
printed = json.dumps(data, indent=2)
print(printed)
# data["pages"] to get the search query pages
pages = data['pages']
for page in pages:
    soup = BeautifulSoup(page['excerpt'], 'html.parser')
    #printing the excerpt
    print("url: " + page['thumbnail']['url'])
    #TODO: Parse the description: if the description feels relevant -> parse the wikipage itself
    print("\n\n" + "title: " + page['title'] +"," + "id: " + "\n")
    print(soup.get_text())