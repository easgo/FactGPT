...
def evaluate_sentence_evidence(gpt_sentence, evidence):
    compare_prompt = f'''
    Using the sentence and evidence below, if the sentence disagrees with the evidence, return using format
    Likely Wrong, Evidence: <Complete sentence/sentences from evidence that disagrees with our sentence>
    
    If the sentence and the evidence are unrelated,
    just return the words "Unclear".
    
    If the evidence contains a statement or statements
    that agree with the sentence, return using format
    Likely Correct, Evidence: <Complete sentence/sentences from evidence that support our sentence>
